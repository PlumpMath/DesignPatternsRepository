 ...
 * 
 * 1. неужели нужно столько хэндеров?
 * 2. мб есть смысл сделать через дженерики, а не if?
 * 3. все таки в Validate я могу передать любую валюту и это не контролируется!
 * 4. return base.Validate(new Ruble(money.ToString()));   тут нет динамики
 * 5. нужно ли реализовывать конечное число купюр и как их задавать изначально банкомату
 * 6. я столько ошибок сделал пока выстраивал цепочку
 * 7. до какого числа домашки сдавать, до 1 декабря?
 */
